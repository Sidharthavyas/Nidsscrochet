          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm" style={{ color: '#6b7280' }}>
                ...
                <Link href="/login" className="font-medium hover:underline" style={{ color: 'var(--pink)' }}>
                  Sign in
                </Link>
              </p>
            ...
            <div className="py-6 px-4 shadow sm:rounded-lg sm:px-10" style={{ background: 'var(--white)' }}>
              <h3 className="text-lg font-medium mb-4" style={{ color: '#111827' }}>Join Nidss Crochet</h3>
